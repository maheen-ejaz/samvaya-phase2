...
const sectionI: QuestionConfig[] = [
  { id: 'Q61', questionNumber: 61, section: 'I', text: 'Do you have any full-time work experience?', type: 'select', required: false, targetTable: 'medical_credentials', targetColumn: 'has_work_experience', options: [{ value: 'true', label: 'Yes' }, { value: 'false', label: 'No' }] },
  { id: 'Q62', questionNumber: 62, section: 'I', text: 'Add your work experience', type: 'timeline', required: false, targetTable: 'medical_credentials', targetColumn: 'work_experience', helpText: 'Add your work experience entries, starting with the most recent.' },
];
...
const sectionJ: QuestionConfig[] = [
  ...
  { id: 'Q68', questionNumber: 68, section: 'J', text: 'Preferred number of children', type: 'select', required: false, targetTable: 'profiles', targetColumn: 'children_count_preference', options: [{ value: '1', label: '1' }, { value: '2', label: '2' }, { value: '3_or_more', label: '3+' }, { value: 'no_preference', label: 'No preference' }] },
  { id: 'Q69', questionNumber: 69, section: 'J', text: 'Preferred timing for children', type: 'select', required: false, targetTable: 'profiles', targetColumn: 'children_timing_preference', options: [{ value: 'within_1_2_years', label: '1-2 years after marriage' }, { value: 'after_3_5_years', label: '3-5 years' }, { value: 'after_milestones', label: 'After career milestones' }, { value: 'no_preference', label: 'No preference' }] },
  { id: 'Q70', questionNumber: 70, section: 'J', text: 'Open to a partner with children?', type: 'select', required: false, targetTable: 'profiles', targetColumn: 'open_to_partner_with_children', options: [{ value: 'yes', label: 'Yes' }, { value: 'no', label: 'No' }, { value: 'open', label: 'Open to it' }] },
  { id: 'Q71', questionNumber: 71, section: 'J', text: 'Preferred countries to settle', type: 'multi_select', required: false, targetTable: 'profiles', targetColumn: 'preferred_settlement_countries', optionsSource: 'countries', searchable: true },
  { id: 'Q72', questionNumber: 72, section: 'J', text: 'Open to relocating for partner?', type: 'select', required: false, targetTable: 'profiles', targetColumn: 'open_to_immediate_relocation', options: [{ value: 'yes', label: 'Yes' }, { value: 'no', label: 'No' }, { value: 'open', label: 'Open to it' }] },
  { id: 'Q73', questionNumber: 73, section: 'J', text: 'Do you have plans to study or work outside India in the next 3 years?', type: 'select', required: false, targetTable: 'profiles', targetColumn: 'plans_to_go_abroad', options: [{ value: 'true', label: 'Yes' }, { value: 'false', label: 'No' }] },
  { id: 'Q74', questionNumber: 74, section: 'J', text: 'Which countries are you exploring?', type: 'multi_select', required: false, targetTable: 'profiles', targetColumn: 'abroad_countries', optionsSource: 'countries', searchable: true },
];
...
const sectionK: QuestionConfig[] = [
  ...
  { id: 'Q91', questionNumber: 91, section: 'K', text: "What are your expectations for your partner's career after marriage?", type: 'illustrated_mc', required: false, targetTable: 'partner_preferences', targetColumn: 'partner_career_expectation_after_marriage', options: [
