...
• A one-time verification fee of ₹7,080 (₹6,000 + 18% GST)
...
The next step is to pay the one-time verification fee of ₹7,080 (₹6,000 + 18% GST). This covers the background verification check that every Samvaya member goes through, ensuring a safe and trusted pool of profiles.
