...
export default async function AdminDashboard() {
  ...
  try {
    ...
    const pipelineStages: PipelineStripStage[] = [
      ...
      { stage: 'Account Created', key: 'signed_up', count: signedUp, conversionPct: null, href: '/admin/applicants?stage=signed_up', ...extractTrend(buildTrend(signedUp, 'signed_up')) },
    ...
    const tasks: AdminTask[] = (tasksData as any[]).map((row: any) => ({
      id: row.id,
      ...
      taskCategory: (row.task_category ?? 'manual') as any,
