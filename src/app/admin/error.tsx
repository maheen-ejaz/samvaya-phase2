  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mb-2 text-lg font-semibold text-gray-900">Admin dashboard error</h2>
        <p className="mb-6 text-sm text-gray-600">
          Failed to load the admin dashboard. Please try again or contact the dev team.
        </p>
        <button
          onClick={reset}
