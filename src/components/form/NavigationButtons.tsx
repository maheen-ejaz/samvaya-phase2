    ...
    <div className="mt-8 flex items-center justify-between">
      ...
      {isLast ? (
        <button
          ...
          className="rounded-lg bg-rose-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500/20 disabled:bg-gray-200 disabled:text-gray-600 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-lg bg-rose-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500/20 disabled:bg-gray-200 disabled:text-gray-600 disabled:cursor-not-allowed"
        >
          Next
          <svg
            className="h-4 w-4"
